...
(function(deferredCode) {
  ...
  var CITY_HALL = [39.95262, -75.16422];
  var ZOOM = 16
  ...
  $(function() {
    ...
    */
    ...
    // test markers
    markers.home = L.marker([39.95261, -75.16422], {
      icon: homeIcon
    }).addTo(lmap);
    markers.polling = L.marker([39.95263, -75.16422], {
      icon: pollingIcon
    }).addTo(lmap);
    markers.congress = L.marker([39.95265, -75.16422], {
      icon: congressIcon
    }).addTo(lmap);
    markers.entrance = L.marker([39.95267, -75.16422], {
      icon: entranceIcon
    }).addTo(lmap);
    markers.handi = L.marker([39.95269, -75.16422], {
      icon: handiIcon
    }).addTo(lmap);
